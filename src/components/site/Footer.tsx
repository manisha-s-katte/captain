      ...
      <div className="flex mx-12 my-20 justify-between">
        <div className="w-1/2 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-24">
              <h1 className='text-2xl font-medium'>Languages and Location</h1>
              <div className="mt-8 space-x-5">
                <select 
                  id='language' 
                  name='language' 
                  className='p-2 mb-4 bg-transparent outline-none border-b-2 border-[#D600E1] w-48 sm:w-auto flex-grow '
                >
        ...
        <div className="w-1/2 flex justify-end">
          <div className="pentagon1 p-16 pl-20 shadow-lg bg-[#310F43] flex justify-center items-stretch h-full">
            {/* Left Partition */}
            ...
            {/* Divider */}
            <div className="border-l border-[#D700E1] mx-4 mb-7"></div>

            {/* Right Partition */}
            <div className="w-1/2 pl-12 pb-0 flex flex-col space-y-12">
