...
const EventPage = () => {
  ...
  return (
    <main className="min-h-screen">
      <section className="block mt-8 mx-16">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 lg:pl-8 mt-8 lg:mt-0 text-left">
            <h2 className="text-5xl tracking-tight view_all font-semibold mb-4">Weekly Wars</h2>
            ...
            <div className="flex space-x-20 mt-12">
              <button className="pentagon w-auto view_all text-2xl bg-[#FCCC4C] text-black py-2 px-4 pr-6 hover:bg-yellow-500">
                Join 200 INR
              </button>
              <button className="pentagonbutton w-auto view_all text-2xl text-white py-2 px-4 pr-6 border-2 border-[#D600E1]">
      ...
      {/* New Section */}
      <section className="mt-16 pb-16 mx-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-20 mt-8">
